...
#+begin_src text :eval no
  「文芸的プログラミング」は、D.クヌース氏が発表したプログラミング手法です。
...
#+begin_src text
  ...
  3つ目は、原稿の各パラグラフにつける小見出しです。
  この小見出しは原稿に載せるものではありませんが、小見出しがあることにより原稿の方向性がぶれることなく書き進められるというメリットがあります。
  ...
  これをとりあえず保存することで心安らかに筆を進めることができます。
