...
:ID:       4853d22e-108e-41b5-a55b-4208e9364b08
:END:
...
#+begin_src text
近年、盛り上がりを見せる生成AIの存在は、「総合的な生産活動の場」としてのEmacsにさらなる可能性をもたらします。
2024年は生成AI関連のEmacs拡張パッケージが成熟期に入り、AIの利用がより容易になりました。
...
:ID:       35675b7c-5828-48aa-b192-a0afddbdc720
:END:
...
** 2023年のEmacsの話題                         :ARCHIVE:
:PROPERTIES:
:CREATED:  [2023-11-29 Wed 15:04]
:ID:       9d7c2ad3-566f-485b-bef4-88b4b8c18e2c
:END:
...
- [[https://lists.gnu.org/archive/html/emacs-devel/2024-05/msg00789.html][A new Emacs maintainer: Andrea Corallo.]]
- [[https://bzg.fr/en/org-has-a-new-maintainer/][🦄 Org Mode has a new maintainer - Bastien Guerry]]
- [[https://gazlog.jp/entry/linux-os-share-uprise/][Linux OSのシェアが過去最高の4.5%を記録。要因はSteam DeckやWindowsの改悪？]]

#+begin_src text
2024年は、EmacsおよびOrg Modeのメンテナ(主要開発者)が、交代や追加公認されるなどしてその顔ぶれが変わるという事がありました。
しかし、このニュースを開発における不安材料だと見るEmacsユーザはあまりいないでしょう。
その理由は、開発方針についての意見交換が日々、オープンな場で行われていることによる安心感があるからではないでしょうか。

折しも2024年はオープンソースで開発されているOSのLinuxが前年比40%増となる市場シェアの4.5%を獲得したことが話題となりました。
これらコミュニティベースで開発されるソフトウェアを利用して、製品ソフトウェアにはない魅力を体感してみてはいかがでしょうか。
#+end_src
